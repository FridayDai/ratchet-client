...
(function ($) {
    ...
    MultipleSelect.prototype = {
        ...
        update: function (isInit) {
            ...
            } else if (this.options.allSelected && this.$selectAll.prop('checked')) {
        ...
        updateSelectAll: function (isInit) {
            ...
            this.$selectAll.prop('checked', $items.length &&
                $items.length + 1 === $items.filter(':checked').length);
        ...
        getSelects: function (type) {
            ...
            if(this.$selectAll.prop('checked')) {
                this.$drop.find(sprintf('input[%s]', this.selectItemName)).each(function () {
