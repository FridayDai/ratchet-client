...
class RatchetConstants {
    ...
    public static final Map TOOL_TYPE = [
            ...
            1001: TOOL_NAME_RISK_ASSESSMENT_QUESTIONNAIRE,
    ...
    public static Integer[] TOOL_TYPE_MULTIPLE_SCORE = [4, 5, 7, 8, 10, 14, 15, 1000, 1001]

    //Task type that has view result.
    public static Integer[] TOOL_TYPE_HAS_VIEW_RESULT = [2, 3, 11, 12, 13, 14, 15, 17, 1000, 1001]
