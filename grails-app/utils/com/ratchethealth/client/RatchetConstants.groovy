...
class RatchetConstants {
    ...
    public static final String TOOL_NAME_NRS_GENERAL = 'NRS-GENERAL';
    ...
    public static final String TOOL_NAME_CAROLINAS_COMFORT_SCALE = 'Carolinas Comfort Scale';
    ...
    public static final Map TOOL_TYPE = [
            ...
            23  : TOOL_NAME_CAROLINAS_COMFORT_SCALE,
    ...
    public static Integer[] TOOL_TYPE_MULTIPLE_SCORE = [4, 5, 7, 8, 10, 14, 15, 20, 23, 1000]

    //Task type that has view result.
    public static Integer[] TOOL_TYPE_HAS_VIEW_RESULT = [2, 3, 11, 12, 13, 14, 15, 17, 20, 21, 22, 23, 1000]
